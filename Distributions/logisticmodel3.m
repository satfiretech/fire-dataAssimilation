%Same as logisticmodel3.m but in this case we would like to test the
%case of 2D (bivariate) logistic, with threshold specified in the paper.
%The different variate are independent.
...
x = 0.000001:0.0001:0.5; %1/3:0.0001:1; %0.00001:0.0001:0.6667; %False alarm probability
z = x;
...
%r = -0.977*log(x)  - 1.503*x + 0.1078;  %VALID FOR 0<X<1/2: step e-4
