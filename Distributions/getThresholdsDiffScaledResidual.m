function [THRESHOLD_ACTIVE1 THRESHOLD_ACTIVE2] = getThresholdsDiffScaledResidual(KeepScaledResidual,CENTREL,CENTRE,N1L,N2L,ON,timestamp,THRESHOLD_COEFFICIENT_CONTEXTUAL)
...
previousDiffScaledResidual1 = nan(8,length(CENTREL),96);
...
DIRECTION_WITH_INFO = ones(1,length(CENTREL))- sum(ON,1);
