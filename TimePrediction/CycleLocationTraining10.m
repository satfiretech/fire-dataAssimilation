function  [MOD,TEST_FIRE_CYCLE,w,TEST_CYCLE_TIME,TEST_FIRE_CYCLE_NUMBER,latitude,longitude,column, row,To_M, Ta_M, tm_M, ts_M, dT_M, k_M, w2_M, tau_M, m_z_M, P_M, v_z_M, v_m_M, theta_z_M, theta_zm_M, theta_zs_M, m_zs_M, tsr_P_M, a_P_M, Y_P_M, Z_P_M, a_RKHS_M, K_RKHS_M, deltaK_RKHS_M, a_SVD_M U_SVD_M deltaU_SVD_M Q, R1, bA, MNs, mp, cycle_out_scope,SunriseDay, SunsetDay, StartDay, tSunriseDay, tSunsetDay, tStartDay, tDayLength, tSolarnoonDay sr ITERATIONS_A FCTCOUNT_A RMSE_NSQ_OVER_MISSING_VALUE_ONLY MAE_NSQ_OVER_MISSING_VALUE_ONLY BIAS_NSQ_OVER_MISSING_VALUE_ONLY tmin_M horizon missingdataFlag]= CycleLocationTraining(COLUMN,ROW,TEST_FIRE_CYCLE_NUMBER,FNDATAREGION, MODEL,ErrFct,ACTIVATE_MISSINGSAMPLE,GAP, DDTP_Nbre_Cycles)
